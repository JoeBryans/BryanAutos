  ...
  return (
    <CldUploadWidget
      ...
      options={{
        ...
        // folder: 'my-nextjs-gallery', // Specific folder in Cloudinary
        // tags: ['nextjs', 'multi-upload'], // Tags for the uploaded images
      }}
